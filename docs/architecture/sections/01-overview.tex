...
\begin{itemize}
  \item Provide a clean target for assemblers, compilers, interpreters, and
        firmware.
  \item Keep the base ISA simple enough to implement in both software and
        hardware.
  ...
  \item Preserve room for future extensions such as atomics, SIMD, vector,
        matrix, or co-processor features.
\end{itemize}

\section{Goals for VIV-32 v\version}

\begin{itemize}
  \item Implement floating-point support.
\end{itemize}

\section{Non-Goals for VIV-32 v\version}
...
\begin{itemize}
  ...
  \item Platform devices and concrete memory maps are specified separately in
        the VIV-32 Platform Specification.
  \item Toolchain object formats, assembler syntax, and linker behaviour are
        specified separately in the VIV-32 Toolchain Specification.
\end{itemize}
